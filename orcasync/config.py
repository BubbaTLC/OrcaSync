...
class Config:
    ...
    def discover_orcaslicer_paths() -> Dict[str, List[Path]]:
        ...
        """
        discovered: dict[str, list[Path]] = {"user": [], "system": []}
    ...
    def _get_default_config(self) -> Dict:
        ...
        return {
            ...
            "profiles": {"default": {"branch_name": "main", "paths": paths_config}},
        }
    ...
    def _load_profile(self) -> Dict:
        ...
        base_config = {
            k: v for k, v in self.data.items() if k not in ["profiles", "default_profile"]
        }
    ...
    def repository_url(self) -> str:
        """Get repository URL."""
        return str(self.active_profile.get("repository_url", ""))

    @property
    def repository_name(self) -> str:
        """Get repository name."""
        return str(self.active_profile.get("repository_name", "orca-profiles"))
    ...
    def branch_name(self) -> str:
        ...
        if "branch_name" in self.active_profile:
            return str(self.active_profile["branch_name"])

        # Otherwise construct from prefix/postfix and hostname
        hostname = platform.node()
        prefix = str(self.active_profile.get("branch_prefix", ""))
        postfix = str(self.active_profile.get("branch_postfix", ""))
